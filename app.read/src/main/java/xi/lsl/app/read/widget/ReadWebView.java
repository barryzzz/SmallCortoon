package xi.lsl.app.read.widget;
...
public class ReadWebView extends WebView {
    ...
    public ReadWebView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ReadWebView(Context context, AttributeSet attrs, int defStyleAttr) {
