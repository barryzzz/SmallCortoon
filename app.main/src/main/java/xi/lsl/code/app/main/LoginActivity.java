...
public class LoginActivity extends BaseActivity {
    ...
    private void gotoLogin(final String s1, final String s2) {
        mSubscription.add(Nets.getShuHuiApis().userLogin(s1, s2, FromType).observeOn(AndroidSchedulers.mainThread()).subscribeOn(Schedulers.io()).subscribe(new Action1<LoginMsg>() {
            @Override
